...
var funcaoPesadaPromiseErro = new Promise(function (resolve, reject) {
  try {
    var execucoes = 0;
    for (var i = 0; i < 1000000000; i++) {
      execucoes++;
...
var promiseComParametros = function promiseComParametros(login, senha) {
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      resolve("Logado com o usuario: ".concat(login));
    }, 3000);
  });
};
...
function mainExecution() {
  return _mainExecution.apply(this, arguments);
}
function _mainExecution() {
  _mainExecution = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var resultado, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          promiseComParametros('ana', 123).then(function (resultado) {
            console.log(resultado);
          });
          _context.p = 1;
          _context.n = 2;
          return funcaoPesadaPromise;
        case 2:
