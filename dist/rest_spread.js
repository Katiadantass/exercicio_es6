...
var timesDeFutebolDeSp = ['São Paulo', 'Corinthians', 'Palmeiras', 'Santos'];
var timesDeFutebolDoRio = ['Flamengo', 'Vasco', 'Botafogo', 'Fluminense'];
...
var carroDoLuiz = _objectSpread(_objectSpread({}, carroDoMax), {}, {
  ano: 1978,
  modelo: 'Dart'
});
...
var motorDoCarroDoMax = carroDoMax.motor;
console.log(motorDoCarroDoMax);

// Extrai e renomeia propriedades
var anoDoCarroDoMax = carroDoMax.ano,
  modeloDoCarroDoMax = carroDoMax.modelo;
var anoDoCarroDoLuiz = carroDoLuiz.ano,
  modeloDoCarroDoLuiz = carroDoLuiz.modelo;
console.log(carroDoMax);
console.log(carroDoLuiz);
